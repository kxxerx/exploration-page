# pollution-exploration v1.17.28-honorific-guide-final-polish

## 적용 순서
1. `pollution-exploration-deploy-only-v1.17.28-honorific-guide-final-polish.zip` 압축을 풉니다.
...
- 이번 버전에서 새 SQL은 없습니다. 단, v1.17.19 / v1.17.22 / v1.17.23 SQL은 기존 기능에 필요합니다.
